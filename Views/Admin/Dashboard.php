        ...
        <div class="col-md-3 mb-3">
            <div class="card text-white bg-success">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="card-title">Total enseignants</h6>
                            <h2 class="mb-0"><?= $nbEns ?? 0 ?></h2>
                        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-dark text-white">
                    <i class="bi bi-people"></i> Top 5 élèves
                </div>
                <div class="card-body">
                    <?php if(!empty($results)): ?>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1; foreach($results as $result => $valeur): ?>
                                    <tr>
                                        <td><?= $i++ ?></td>
                                        <td><?= htmlspecialchars($valeur['nom']) ?></td>
                                        <td><?= htmlspecialchars($valeur['prenom']) ?></td>
                                        <td><?= htmlspecialchars($valeur['note']) ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
